...
export const projects = [
  {
  id: "aws-serverless-contact-event-logger",
  slug: "aws-serverless-contact-event-logger",

  title: "AWS Serverless Contact Event Logger",
  shortDescription: "A serverless AWS Lambda application that processes contact form requests through a Function URL and logs execution details to CloudWatch.",
  status: "Completed",
  difficulty: "Beginner",
  ...
  liveDemoUrl: "",
  githubUrl: "",
  youtubePlaylistUrl: "https://youtu.be/n2CuB0v-h3M",

  overview: {
    problem: "Traditional web applications require servers to process simple form submissions, increasing infrastructure management overhead.",
    solution: "Implemented a serverless AWS Lambda function that receives and processes contact form requests through a Lambda Function URL.",
    goal: "Learn AWS Lambda, serverless architecture, CloudWatch monitoring, and Function URL integration.",
    targetUsers: "Developers and cloud learners interested in event-driven serverless applications.",
  },
  ...
  architecture: {
    description: "The application exposes a Lambda Function URL that accepts HTTP POST requests. Lambda validates and processes the JSON payload, then logs execution details to CloudWatch.",
    diagramImage: "",
    requestFlow: [
  ...
  implementationSteps: [
    {
      ...
      description: "Created a Python-based Lambda function using the AWS Management Console.",
      commands: [],
      screenshot: "",
    },
    {
      title: "Implement Request Processing Logic",
      description: "Added JSON parsing and validation for incoming contact form requests.",
      commands: [],
      screenshot: "",
    },
    {
      title: "Configure Function URL",
      description: "Exposed the Lambda function through a public HTTPS endpoint using Lambda Function URLs.",
      commands: [],
      screenshot: "",
    },
    {
      title: "Test Using Postman",
      description: "Sent HTTP POST requests and verified successful responses.",
      commands: [],
      screenshot: "",
    },
    {
      title: "Monitor with CloudWatch",
      description: "Verified execution logs and request data using Amazon CloudWatch Logs.",
      commands: [],
      screenshot: "",
    }
  ],
  ...
  screenshots: [
    {
      ...
      image: "",
      description: "AWS Lambda configuration showing runtime, memory allocation, and timeout settings.",
    },
    {
      title: "Function URL Configuration",
      image: "",
      description: "Lambda Function URL setup used to expose the application through HTTPS.",
    },
    {
      title: "Postman Test Request",
      image: "",
      description: "Successful API request and response during testing.",
    },
    {
      title: "CloudWatch Logs",
      image: "",
      description: "Execution logs generated by Lambda during request processing.",
    }
  ],
  ...
  videos: [
    {
      ...
      youtubeUrl: "https://youtu.be/n2CuB0v-h3M",
      embedUrl: "https://www.youtube.com/embed/n2CuB0v-h3M",
      description: "Complete walkthrough of building and configuring the AWS Lambda project.",
    },
    {
      title: "Lambda Function Demonstration",
      youtubeUrl: "https://youtu.be/n2CuB0v-h3M",
      embedUrl: "https://www.youtube.com/embed/n2CuB0v-h3M",
      description: "Demonstration of request processing and CloudWatch logging.",
    }
  ],
  ...
  challenges: [
    {
      ...
      lessonLearned: "Serverless applications can expose APIs without managing web servers.",
    },
    {
      ...
      lessonLearned: "Monitoring is a critical component of cloud applications.",
    }
  ],
  ...
  costConsiderations: [
    {
      service: "AWS Lambda",
      estimatedCost: "Within Free Tier",
